# taken from https://stackoverflow.com/questions/7544461/is-inline-code-allowed-in-jinja-templates
# User: Aaron de Windt (https://stackoverflow.com/users/186964/aaron-de-windt)
